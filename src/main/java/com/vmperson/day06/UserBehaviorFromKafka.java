...
/**
 * @ClassName: UserBehaviorFromKafka
 * @Description: TODO 从kafka消费数据，实时计算TOPN
 * @Author: VmPerson
...
public class UserBehaviorFromKafka {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //读取数据
        SingleOutputStreamOperator<UserBehavior> pv = env.addSource(new FlinkKafkaConsumer011<String>("hotItems", new SimpleStringSchema(), properties))
